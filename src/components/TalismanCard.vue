...
<style scoped>
.talisman-outer { position: relative; background: linear-gradient(160deg, rgba(13,8,32,0.97) 0%, rgba(20,10,50,0.97) 100%); border: 0.5px solid; border-radius: 16px; padding: 20px 16px 16px; overflow: hidden; width: 100%; max-width: 380px; }
.corner-rune { display: flex; align-items: center; justify-content: center; font-size: 11px; color: rgba(201,168,76,0.35); pointer-events: none; }
.scan-line { position: absolute; left: 0; right: 0; height: 1px; background: linear-gradient(90deg, transparent, rgba(201,168,76,0.3), transparent); pointer-events: none; transition: top 0s; }
...
.tc-dot { margin: 0 5px; }
.tc-judgement { background: rgba(201,168,76,0.05); border: 0.5px solid rgba(201,168,76,0.15); border-radius: 8px; padding: 8px 12px; margin-bottom: 10px; }
...
.tc-fortune { background: rgba(30,15,70,0.6); border: 0.5px solid rgba(100,80,200,0.2); border-radius: 8px; padding: 10px 12px; margin-bottom: 10px; }
...
.tc-hash { display: flex; align-items: center; gap: 6px; background: rgba(42,140,90,0.07); border: 0.5px solid rgba(42,140,90,0.2); border-radius: 6px; padding: 6px 10px; margin-bottom: 12px; }
...
.tc-share { width: 100%; padding: 11px; background: linear-gradient(135deg, rgba(80,20,140,0.55), rgba(139,26,26,0.55)); border: 0.5px solid rgba(201,168,76,0.4); border-radius: 20px; color: #c9a84c; font-size: 13px; letter-spacing: .1em; font-weight: 500; cursor: pointer; transition: opacity .15s; }
